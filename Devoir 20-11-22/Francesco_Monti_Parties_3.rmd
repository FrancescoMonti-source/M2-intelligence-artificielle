...
knitr::opts_chunk$set(warning = F) # setting chunk options globally
```
...
# Recording qualitative variables as factors
# Health insurance
...
# Marital status
data$q5_sd4_r1 = factor(data$q5_sd4_r1, labels = c("Married/Partnered/Concubine", "Single/Divorced/Separated/Widowed"))
```
